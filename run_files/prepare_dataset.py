...
data = [
    [os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_01_#108664/obj_train_data/batch_01'),
     os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_01_#108664/obj_train_data/batch_01_'), 1.0],
    [os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_02_#110902/obj_train_data/batch_02'),
     os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_02_#110902/obj_train_data/batch_02_'), 1.0],
    [os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_03_#112497/obj_train_data/batch_03'),
     os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_03_#112497/obj_train_data/batch_03_'), 1.0],
    [os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_04_#119178/obj_train_data/batch_04'),
     os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_04_#119178/obj_train_data/batch_04_'), 1.0],
    [os.path.join(ROOT_DIR, 'datasets/От разметчиков/batch_05_#147536/batch_05'),
    ...
    [os.path.join(ROOT_DIR, 'datasets/diff/diff/cam_2/init'),
     os.path.join(ROOT_DIR, 'datasets/diff/diff/cam_2/boxes'), 0.25],
]
