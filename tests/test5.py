...
#                 - box sequence
stat = {}
if not os.path.isdir(os.path.join(ROOT_DIR, f'temp/crop_frames')):
    os.mkdir(os.path.join(ROOT_DIR, f'temp/crop_frames'))
start = time.time()
for class_ in os.listdir(dataset):
    if not os.path.isdir(os.path.join(ROOT_DIR, f'temp/crop_frames/{class_}')):
        os.mkdir(os.path.join(ROOT_DIR, f'temp/crop_frames/{class_}'))
    # print(class_)
    box_data[class_] = {}
