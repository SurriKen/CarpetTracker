...
# }
# video_paths = {
#     'model_1': os.path.join(ROOT_DIR, f'datasets/class_videos_28/60x90/camera_1/14.mp4'),
#     'model_2': os.path.join(ROOT_DIR, f'datasets/class_videos_28/60x90/camera_2/14.mp4'),
#     'save_path': save_folder,
# }
video_paths = {
    'model_1': "/dev/video0",
...
result = predict(video_paths=video_paths, stream=True, save_predict_video=True)
