...
train(epochs=50, weights='runs/detect/camera_1_mix++_8n_150ep/weights/last.pt', config='data_custom_CAM1.yaml',
      name='camera_1_mix+++_8n_200ep')
train(epochs=50, weights='runs/detect/camera_2_mix++_8n_150ep/weights/last.pt', config='data_custom_CAM2.yaml',
