...
from parameters import KMEANS_MODEL_FOLDER, CARPET_SIZE_LIST, MIN_OBJ_SEQUENCE, KMEANS_MODEL_NAME
from utils.datasets import LoadStreams, LoadImages
from utils.general import check_img_size, check_requirements, check_imshow, non_max_suppression, apply_classifier, \
    scale_coords, xyxy2xywh, strip_optimizer, set_logging, increment_path
from utils.plots import plot_one_box, get_colors, get_object_count, add_headline_to_image, get_obj_box_squares
...
def kmeans_predict(model, lbl_dict, array):
...
def detect(save_img=False):
    ...
    print('Kmeans_cluster_names', Kmeans_cluster_names)
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        # print(pred, pred[0].size(dim=0), pred[0].tolist())
